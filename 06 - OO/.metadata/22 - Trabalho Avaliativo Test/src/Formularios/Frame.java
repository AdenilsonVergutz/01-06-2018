...
import Controladores.ArmazemDaCerveja;
import Controladores.Main;
import Controladores.Produto;
import Controladores.SmartField;



public class Frame {
	
	private static ArmazemDaCerveja Armazem;
	private static JTable tabelaEstoque;
	private static JTable tabelaPedido;
	private static JTable tabelaEstatisticas;
	
	public static JFrame getMainFrame(ArmazemDaCerveja armazemDaCerveja) {
		
		Frame.Armazem = armazemDaCerveja;
	...
	public static JFrame getAddAoPedidoFrame(Pedido pedido) {
		...
		btnAdicionar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Produto pdt = Armazem.getProduto(Frame.tabelaEstoque.getSelectedRow());
	...
	public static JFrame getEstatisticasFrame() {
		...
		edtFiltro.addKeyListener(new KeyListener() {
			...
			public void keyTyped(KeyEvent e) {
				...
				tabelaEstatisticas.setModel(Armazem.getListaEstatisticas(edtFiltro.getText()));
	...
	public static JScrollPane getScrollPane() {
		...
		tabela.setModel(Armazem.getLista());
	...
	public static JScrollPane getScrollPedidos(JLabel lblPreco) {
		...
		tabela.setModel(Armazem.getListaPedidos());
		...
		tabela.addMouseListener(new MouseListener() {
			...
			public void mousePressed(MouseEvent e) {
				...
				Frame.tabelaPedido.setModel(Armazem.getPedido(i).getLista());
				
				try {
					lblPreco.setText("R$ " + Armazem.getPedido(i).getTotal());
				} catch (Exception ex) {}
			}
			@Override
	...
	public static JScrollPane getScrollEstatisticas() {
		...
		tabela.setModel(Armazem.getListaEstatisticas(""));
